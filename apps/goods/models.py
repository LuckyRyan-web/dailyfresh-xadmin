...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='type', verbose_name='商品类型图片')      #upload_to随便写，反正用的是fdfs存储
...
class Goods(BaseModel):
    ...
    # 富文本类型：带有格式的文本
    detail = UEditorField(blank=True, verbose_name='商品详情',width=1000, height=300, imagePath="goods/ueditor", filePath="goods/ueditor", default='')
